...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Chính sách bảo mật thông tin khách hàng | AWEB Computer Technology</title>
    ...
    <h1 class="hnc-static-heading1">CHÍNH SÁCH BẢO MẬT THÔNG TIN KHÁCH HÀNG CỦA AWEB</h1>
    <br>
    ...
    <div class="hnc-content-box-container">
        ...
        <div class="hnc-content-box">
            <p class="hnc-static-text">Để truy cập và sử dụng một số dịch vụ tại AWEB, bạn có thể sẽ được yêu cầu đăng ký với chúng tôi thông tin cá nhân (Email, Họ tên, Số ĐT liên lạc…). Mọi thông tin khai báo phải đảm bảo tính chính xác và hợp pháp, AWEB không chịu mọi trách nhiệm liên quan đến pháp luật của thông tin khai báo, Chúng tôi cũng có thể thu thập thông tin về số lần viếng thăm, bao gồm số trang bạn xem, số links (liên kết) bạn click và những thông tin khác liên quan đến việc kết nối đến site AWEB. Chúng tôi cũng thu thập các thông tin mà trình duyệt Web (Browser) bạn sử dụng mỗi khi truy cập vào AWEB, bao gồm: địa chỉ IP, loại Browser, ngôn ngữ sử dụng, thời gian và những địa chỉ mà Browser truy xuất đến.</p>
        </div>
    </div>
    <div class="hnc-content-box-container">
    ...
    <div class="hnc-content-box-container">
        ...
        <div class="hnc-content-box">
            <p class="hnc-static-text">Nội dung của “Chính sách bảo mật” này có thể thay đổi để phù hợp với các nhu cầu của AWEB cũng như nhu cầu và sự phản hồi từ khách hàng nếu có. Khi cập nhật nội dung chính sách này, chúng tôi sẽ chỉnh sửa lại thời gian “Cập nhật lần cuối” bên trên. Nội dung “Chính sách bảo mật” này chỉ áp dụng tại AWEB, không bao gồm hoặc liên quan đến các bên thứ ba đặt quảng cáo hay có links tại AWEB. Do đó, chúng tôi đề nghị bạn đọc và tham khảo kỹ nội dung “Chính sách bảo mật” của từng website mà bạn đang truy cập.</p>
        </div>
    </div>
    <div class="hnc-content-box-container">
        <h3 class="hnc-static-heading3 hnc-content-box-ribbon">6. THÔNG TIN LIÊN HỆ</h3>
        <div class="hnc-content-box">
            <p class="hnc-static-text">Chúng tôi luôn hoan nghênh các ý kiến đóng góp, liên hệ và phản hồi thông tin từ bạn về “Chính sách bảo mật” này. Nếu bạn có những thắc mắc liên quan xin vui lòng liên hệ theo địa chỉ Email: cskh@AWEBcomputer.com</p>
        </div>
    </div>
</div>
    </div>
